...
(function (t) {
  ...
  var e = t.GreenSockGlobals || t,
    ...
    g = function (t, e, i, s, o) {
        ...
        for (P = !D || (!R && !A), f = 0; k.length > f; f++) {
          for (
            ...
            "BR" !== l[d].nodeName &&
              ...
              D &&
                (0 === d &&
                  ((w.style.top = y._y + "px"), (w.style.left = I + T + "px")),
                (y.style.top = "0px"),
      ...
      D &&
        (z > t.clientHeight &&
          ((t.style.height = z - F + "px"),
          z > t.clientHeight && (t.style.height = z + E + "px")),
        B > t.clientWidth &&
          ((t.style.width = B - U + "px"),
          B > t.clientWidth && (t.style.width = B + N + "px")));
    },
    v = d.prototype;
  (v.split = function (t) {
